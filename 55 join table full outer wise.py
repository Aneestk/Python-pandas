...
dic2={
    'prof':['python','python','bigdata','bigdata','java','java'],
...
#newfname=pd.merge(df1,df2,on='columnname',how='type')

a=pd.merge(df1,df2,on='id',how='outer') [['fname','lname','prof','salary','loc']]
print(a)